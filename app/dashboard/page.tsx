      ...
      <div className="flex min-h-screen flex-col md:flex-row">
        ...
        <main className="min-w-0 flex-1 px-4 py-6 sm:px-7 lg:px-10 lg:py-8">
          ...
          <section className="mb-7 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <Link href="/products" className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-md"><div><p className="text-sm font-medium">Toplam Ürün</p><p className="text-2xl font-bold">42</p><p className="text-xs font-semibold text-green-600">+5 bu hafta</p></div></Link>
